...
NEARDATA struct artifact artilist[] = {
    ...
    A("The Tooth of Tarrasque", "blade-like tooth", None, DAGGER, DAGGER,
         ...
         AF_FAMOUS | AF_NOGEN | AF_NO_WISH | AF_RESTR, AF2_FLOOR_TILE | AF2_MISSILE_TILE | AF2_NO_MATERIAL_NAME, SPFX_REGEN, SPFX_NONE, M2_NONE,
    ...
    A("The Prime Codex", "ornamental alien", None, SPE_BOOK_OF_MODRON, SPE_BOOK_OF_MODRON,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_RESTR | AF_FAMOUS | AF_READABLE | AF_NO_WISH), AF2_INDESTRUCTIBLE | AF2_FLOOR_TILE, SPFX_NONE,
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    CAGED_SPEECH_DEMON,         // Item type
    CAGED_SPEECH_DEMON,         // Mask type
    MAT_NONE,                     // Material
    ...
    SPFX_NONE /*SPFX_UNLUCK*/,   // Passive effects when carried in your inventory
    ...
    0L,                           // Cost (gold?)
    CLR_BLACK,                    // Glow color
    CLR_RED,                      // Object color
    48,                           // Height
